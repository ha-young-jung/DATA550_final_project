...
\\\
\\
log(\frac{\mu_i}{pop_i}) = \beta_0 + \beta_1\,poverty\_rate_i + \beta_2\,vacancy\_rate_i + \beta_3\,unemployment\_rate_i + \beta_4\,pct\_black_i + \beta_5\,dist\_to\_road_i + \beta_6\,dist\_to\_treatment_i + \theta_i
\\\
\\
